...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST,"/movies/**").hasAnyRole("ADMIN", "OWNER")
                .antMatchers(HttpMethod.PUT,"/movies/**").hasAnyRole("ADMIN", "OWNER")
                .antMatchers(HttpMethod.DELETE,"/movies/**").hasAnyRole("ADMIN", "OWNER")
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
