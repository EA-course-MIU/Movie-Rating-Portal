...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST,"/movies/**").hasAnyRole("ADMIN", "EDITOR")
                .antMatchers(HttpMethod.PUT,"/movies/**").hasAnyRole("ADMIN", "EDITOR")
                .antMatchers(HttpMethod.DELETE,"/movies/**").hasAnyRole("ADMIN", "EDITOR")
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
